<html lang="en">
 ...
 <title>MI CARTA DIGITAL - CATEGORIA - BEBIDAS</title>
   <?php 
...
<form method="post" action="subcategoria-post.php">
  ...
  <main class="mt-2">
    ...
    <a  data-toggle="modal" href="#modalpromo" role="button" class="btn btn-dark">PROMO DEL DIA</a>
        ...
        <div class="text-center p-2" style="background: rgba(0,0,0,0);">BEBIDAS
     ...
     <hr class="my-2" />
      ...
      <section >
        <div class="row">
           <?php 
           include("carta/subcategoria8-ul1.php");
           include("carta/subcategoria8-ul2.php");
